package com.eny.i18n.plugin.core.ide.references.translation

import com.eny.i18n.plugin.core.key.KeyComposerService
import com.eny.i18n.plugin.core.key.Separators
...
internal class TranslationToCodeReferenceProvider {
    ...
    fun getReferences(element: PsiElement, textRange: TextRange, parents: List<String>): List<PsiReference> {
        ...
        val key = project.service<KeyComposerService>().composeKey(
            parents,
...
class ReferencesAccumulator(private val key: String) {
     ...
     */
    fun process() = { entry: PsiElement, _:Int ->
